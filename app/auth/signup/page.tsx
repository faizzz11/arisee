...
export default function SignUp() {
    ...
    return (
        <div className="min-h-screen bg-background dark:bg-black flex flex-col items-center justify-center px-6">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-4xl font-bold tracking-tight dark:text-white text-black mb-4">
                        Join the AI education revolution
                    </h2>
                    <p className="text-muted-foreground text-lg">
                        Create your ARISE account and unlock AI-powered tools for teaching, learning, and educational content creation
                    </p>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="text-center">
                        <p className="text-muted-foreground text-sm">
                            Already part of the ARISE community?{" "}
                            <Link
                                href="/auth/signin"
                    ...
                    <div className="text-center pt-6">
                        <p className="text-muted-foreground text-xs">
                            By joining ARISE, you agree to help shape the future of education with AI. See our{" "}
